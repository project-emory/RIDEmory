...
public enum Locations {
    ...
    RIDESHARE(new GeoJsonPoint(33.642562, -84.444187)),
    RAOUL_CIRCLE(new GeoJsonPoint(33.794812, -84.324562)),
    AMUC(new GeoJsonPoint(33.793813, -84.322563)),
    COMPLEX(new GeoJsonPoint(33.790437, -84.321438)),
    ...
    ATL_INTL(new GeoJsonPoint(33.640563, -84.418188));
